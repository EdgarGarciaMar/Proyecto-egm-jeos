 ...
 * @author edgar y lalo
 */
@WebServlet(name = "ProductoServlet_admin", urlPatterns = {"/ProductoServlet_admin"})
public class ProductoServlet_admin extends HttpServlet {
    ...
    private void listaDeProductos(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/productos/listaProductos_admin.jsp");
            rd.forward(request, response);
        } catch (SQLException | ServletException | IOException ex) {
            Logger.getLogger(ProductoServlet_admin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void mostrarProducto(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher vista = request.getRequestDispatcher("/productos/datosProducto_admin.jsp");
