 ...
 * @author edgar y lalo
 */
@WebServlet(name = "CategoriaServlet_admin", urlPatterns = {"/CategoriaServlet_admin"})
public class CategoriaServlet_admin extends HttpServlet {
    ...
    private void listaDeCategorias(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/categorias/listaCategorias_admin.jsp");
            rd.forward(request, response);
        } catch (SQLException | ServletException | IOException ex) {
            Logger.getLogger(CategoriaServlet_admin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void mostrarCategoria(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher vista = request.getRequestDispatcher("/categorias/datosCategoria_admin.jsp");
